...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    #We can use fuction play() only the score of Player 0 and Player 1 are less than goal
    while score0 < goal and score1 < goal:
        ...
        #To use special rules to fit scores of player 0 and player 1
        if player == 0:
            num_rolls = strategy0(own_score, opp_score)
        else:
            num_rolls = strategy1(own_score, opp_score)

        #use function take_turn() to fit Hog prime , pig out and free_Bacon
        curr_turn = take_turn(num_rolls, opp_score, curr_dice)

        #current player's score
        own_score = own_score + curr_turn
        ...
        if player == 0:
            ...
            if is_swap(own_score, opp_score):
                ...
                score1, score0 = own_score, opp_score

        #end of current player, need to change the player.
        player = other(player)
